...
const productTextMap = {
  ...
  "BANANE BROCHETTES": { fr: { nom: "BANANE BROCHETTES", description: "Brochettes à la Banane", longDescription: "Des brochettes à la banane, colorées et généreuses pour une dégustation savoureuse." }, en: { nom: "BANANA SKEWERS", description: "Banana Skewers", longDescription: "Colorful banana skewers, generously prepared for a satisfying meal." } },
...
const plats = [
  ...
  { nom: "BANANE BROCHETTES", description: "Brochettes à la Banane", prix: "4 500 FCFA", image: "asset/images/plats/brochettes_legumes.jpeg", categorie: "plats" },
